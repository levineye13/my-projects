  ...
  return (
    <header className="header">
      <a href="#" className="header__link-logo" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" className="header__logo" viewBox="0 0 782 980">
      ...
      <button className="header__menu-button" onClick={handleClickButtonMenu}>
        <span className={`header__button-element ${isButtonActive ? 'header__button-element_active' : ''}`} />
      </button>
      <nav className={`header__menu ${isOpenMenu ? 'header__menu_opened' : ''}`}>
        <ul className="header__list">
          <li className="header__item">
            <a href="#" className="header__link header__link_active">Обо мне</a>
          </li>
          <li className="header__item">
