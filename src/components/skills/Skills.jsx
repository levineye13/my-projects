  ...
  return (
    <section className="skills content__skills" id="skills">
      ...
      <ul className="skills__list">
        ...
        <li className="skills__item">
          <h3 className="skills__subtitle">{translation.backend}</h3>
          <ul className="skills__sublist">
            <li className="skills__subitem">
              <a
        ...
        <li className="skills__item">
          <h3 className="skills__subtitle">{translation.database}</h3>
          <ul className="skills__sublist">
            <li className="skills__subitem">
              <a
        ...
        <li className="skills__item">
          <h3 className="skills__subtitle">{translation.instruments}</h3>
          <ul className="skills__sublist">
            <li className="skills__subitem">
              <a
